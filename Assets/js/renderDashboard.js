...
function displayDashboard() {
  if (userSessionObj.RecycleNowJwt && userSessionObj.type === "true") {
    document.getElementById("adminDashboardContainer").innerHTML = `
        <div class="profile">
            <div id="details">
                <img id="profilePicture" loading="lazy" src="../Assets/Images/user-solid.svg" alt="profile picture" height="150px" width="150px">
                <div class="username">
            ...
            <div class="greetingsand-update">
                ...
                <form id="updateDetails" action="" method="post" style="display: none; border-radius: 10px; padding: 2rem">
